...
class CurriculumsControllerTest < ActionController::TestCase
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post :create, curriculum: { academicterm_id: @curriculum.academicterm_id, departmentlessons_id: @curriculum.departmentlessons_id, instructor_id: @curriculum.instructor_id }
    end
  ...
  test "should update curriculum" do
    patch :update, id: @curriculum, curriculum: { academicterm_id: @curriculum.academicterm_id, departmentlessons_id: @curriculum.departmentlessons_id, instructor_id: @curriculum.instructor_id }
    assert_redirected_to curriculum_path(assigns(:curriculum))
  end
