...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { department_id: @classroom.department_id, number: @classroom.number, size: @classroom.size }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { department_id: @classroom.department_id, number: @classroom.number, size: @classroom.size }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
