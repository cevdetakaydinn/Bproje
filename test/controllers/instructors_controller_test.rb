...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { email: @instructor.email, id_number: @instructor.id_number, name: @instructor.name, password: @instructor.password, rank: @instructor.rank, surname: @instructor.surname }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { email: @instructor.email, id_number: @instructor.id_number, name: @instructor.name, password: @instructor.password, rank: @instructor.rank, surname: @instructor.surname }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
